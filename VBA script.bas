...
Sub VBAmodule2()
   ...
   For Each CurrentWs In Worksheets
        ...
        CurrentWs.Cells(1, 10).Value = "Quaterly Change"
        ...
        For i = 2 To lastRow
            ...
            If CurrentWs.Cells(i + 1, 1).Value <> CurrentWs.Cells(i, 1).Value Then
              ...
              ClosePrice = CurrentWs.Cells(i, 6).Value
               ...
               QuaterlyChange = (ClosePrice - OPrice)
              
              CurrentWs.Range("J" & summaryTickerRow).Value = QuaterlyChange

                If OPrice = 0 Then
                    PercentChange = 0
                Else
                    PercentChange = QuaterlyChange / OPrice
                End If
